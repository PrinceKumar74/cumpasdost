      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="col-span-1 lg:col-span-1">
          <div className="flex items-center mb-4">
            {/* FIX: Replaced the local logo import with a reliable placeholder to resolve the build error. */}
            <img
              className="h-12 w-auto mr-2"
              src="https://placehold.co/150x50/F97316/FFFFFF?text=CumpasDost"
              alt='logo'
            />
          </div>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2 text-gray-600 text-sm">
            ...
            <li><Link to="/ai" className="hover:text-orange-600 transition-colors">AI</Link></li>
