  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white py-16 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-7xl mx-auto text-center">
       ...
       <p className="text-lg leading-relaxed gap: mb-8"> Alongside being a service provider, Cumpasdost is your committed partner for success, enabling you to outshine your competitors with the latest solutions. Your goals are a priority for us, and for that reason, we consistently evolve as a company. We are dedicated to accomplish everything with excellence so that surpassing expectations becomes the new standard. But it's not just about delivering results; we actually care about your business. Every project to us is not only a task, but a long-term partnership on trust, commitment, and joint success.</p>
