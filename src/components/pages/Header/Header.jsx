        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <div className="flex-shrink-0 flex items-center">
              <Link to="/">
                <img
                  className="block h-15 w-auto cursor-pointer"
                  src={logo}
                  alt="logo"
                />
              </Link>
          ...
          <div className="hidden md:flex items-center">
            <Link to="/contact">
              <button className="bg-orange-600 hover:bg-orange-700 text-white px-6 py-2 rounded-full font-medium transition-colors flex items-center">
